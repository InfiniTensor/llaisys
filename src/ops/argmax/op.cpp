...
void argmax(tensor_t max_idx, tensor_t max_val, tensor_t vals) {
    ...
    ASSERT(max_idx->ndim() == 1 && max_idx->numel() == 1, "Argmax: max_idx must be 1D tensor with 1 element.");
    ASSERT(max_val->ndim() == 1 && max_val->numel() == 1, "Argmax: max_val must be 1D tensor with 1 element.");
