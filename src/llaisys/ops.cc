...
__C {
    ...
    int64_t llaisysSample(llaisysTensor_t logits, float temperature, int top_k, float top_p, uint64_t seed) {
        return llaisys::ops::sample(logits->tensor, temperature, top_k, top_p, seed);
    }
}
