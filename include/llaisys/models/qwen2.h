...
__C {
    ...
    struct LlaisysQwen2Model;
     ...
     __export struct LlaisysQwen2Model *llaisysQwen2ModelCreate(const LlaisysQwen2Meta *meta, llaisysDeviceType_t device, int *device_ids, int ndevice) noexcept;

     __export void llaisysQwen2ModelDestroy(struct LlaisysQwen2Model * model) noexcept;
